...
public class JouerMenu extends Menu {

    public JouerMenu(MenuController controller) {
        super(TypeMenu.JOUER, controller);
    }
    ...
    protected void build() {
        ...
        addLabel("JOUER", WIDTH / 2f, HEIGHT * 0.65f, 72, OR_PALE);
